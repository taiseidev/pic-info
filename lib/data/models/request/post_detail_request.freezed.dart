...
class _$PostDetailRequestImpl implements _PostDetailRequest {
  const _$PostDetailRequestImpl({required this.id});
  ...
  @override
  String toString() {
    return 'PostDetailRequest(id: $id)';
  }
...
abstract class _PostDetailRequest implements PostDetailRequest {
  const factory _PostDetailRequest({required final int id}) =
